...
public class Lab1 {
	...
	public static Point s0 = new Point(13,3),s1 = new Point(6,6),s2 = new Point(11,7),s3 = new Point(14,7),s4  = new Point(19,9),s5 = new Point(18,9),s6 = new Point(11,9),s7 = new Point(7,9),s8 = new Point(1,10),s9 = new Point(1,11),s10 = new Point(6,11),s11 = new Point(12,11),s12 = new Point(9,5),s13 = new Point(10,8), s14 = new Point(15,8), s15 = new Point(13,10), s16 = new Point(6,10), s17 = new Point(5,13), s18 = new Point(12,14), s19 = new Point(14,5);
